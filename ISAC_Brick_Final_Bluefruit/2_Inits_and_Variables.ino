...
#include "Adafruit_BLE.h"  //Adafruit's general bluetooth board library
#include "Adafruit_BluefruitLE_SPI.h"  //the file for the hardware communication type used in the Feather M0 Bluefruit
...
//pins for the NRF51822
#define BLUEFRUIT_CS   8    // NRF51822 chip select pin
#define BLUEFRUIT_IRQ  7    // NRF51822 interrupt request pin
#define BLUEFRUIT_RST  4    // NRF51822 reset pin
...
boolean try_to_connect = false;  //am I currently trying to connect to Central blutooth devices?
boolean connectable = false;  //can other devices connect to me? (could be found using AT commands but not easily)
boolean last_connected = false;  //was I just connected?  (used for detecting a disconnect)
boolean constant_bt_data = false;  //should I constantly send the data over bt?
...
unsigned long bt_scan_start = 0;  //when did I start being available over bluetooth (millis)
...
//init the bluefruit over hardware SPI
Adafruit_BluefruitLE_SPI bt(BLUEFRUIT_CS, BLUEFRUIT_IRQ, BLUEFRUIT_RST);
