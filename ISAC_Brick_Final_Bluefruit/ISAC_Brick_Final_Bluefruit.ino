 ...
 * Main board is an Adafruit Feather M0 Bluefruit, which will relay data to the user over a bluetooth-UART
 * A custom companion smartphone app will be created for this project, but any bluetooth-uart connection should work fine
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//!!!   THIS IS THE CODE FOR THE ADAFRUIT BLUEFRUIT M0/NRF51822 BOARD VARIANT    !!!
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
// - TVOC and CO2 sensor seems to be tempermental
...
// - Battery life is short and charge time is very long (18 hours? - test this)
//   main power draw is neopixels and 5v converter/PMS5003 - not much to do about them
//   could put ATSAMD21 into sleep mode but probably wouldn't change much compared to the overall power draw
//   can't put bt radio into sleep mode and probably wouldn't change much compared to the overall power draw
//   reference for above - https://forums.adafruit.com/viewtopic.php?f=24&t=133320
...
// - When swapping from the Feather to the Feather Bluefruit, several random pieces of hardware stopped functioning
//   fix - The Feather Bluefruit has a DFU pin that is in the same place as a Ground pin on the Feather
//   make sure the ground wire is connected to a ground pin and not the DFU pin when swapping dev boards.
